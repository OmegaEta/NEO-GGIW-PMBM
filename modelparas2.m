...
load('ParallelTargetGroundTruth.mat')
% load('ParallelTargetVXdistance10T30Poisson8s.mat')
% load('ParallelTargetGroundTruthVXdistance10T30s.mat')
...
model.birth.GGIW = repmat(struct('a',100,'b',10,'m',[],'P',diag([10,10,10,10]),'v',22.5,'V',72.5*eye(2)),[nbirths,1]);
for i = 1:nbirths
