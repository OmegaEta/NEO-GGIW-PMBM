load('TargetInProximity.mat')
load('TargetInProximityGroundTruth_original.mat')
...
model_original.birth.GGIW = repmat(struct('a',15e3,'b',1e3,'m',[],'P',diag([ 50; 50; 5; 5 ])*diag([ 50; 50; 5; 5 ])','v',14,'V',15*eye(2)),[nbirths,1]);
for i = 1:nbirths
